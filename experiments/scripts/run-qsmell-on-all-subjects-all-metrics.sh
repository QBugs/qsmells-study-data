...
# generated by the `get-quantum-circuit-as-a-matrix.sh`) and compute all smell
# metrics.
#
# Usage:
...
#   [--output_dir_path <path, e.g., ../data/generated/smell-metrics>]
#   [help]
# ------------------------------------------------------------------------------
...
USAGE="Usage: ${BASH_SOURCE[0]} [--subjects_file_path <path, e.g., ../data/subjects.csv>] [--matrices_dir_path <path, e.g., ../../subjects/data/generated/quantum-circuit-as-matrix] [--output_dir_path <path, e.g., ../data/generated/smell-metrics>] [help]"
...
OUTPUT_DIR_PATH="$SCRIPT_DIR/../data/generated/smell-metrics"
